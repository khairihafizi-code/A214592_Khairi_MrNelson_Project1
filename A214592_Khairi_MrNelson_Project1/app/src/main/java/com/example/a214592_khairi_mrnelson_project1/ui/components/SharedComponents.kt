package com.example.a214592_khairi_mrnelson_project1.ui.components
...
@Composable
fun CommentCard(comment: com.example.a214592_khairi_mrnelson_project1.model.CommentData, onLikeClick: () -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
